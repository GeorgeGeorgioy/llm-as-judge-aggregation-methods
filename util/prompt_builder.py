...
if __name__ == "__main__":
    yaml_path = Path("/work3/s233559/Thesis/data/templates/helueval_g.yalm")
    csv_path = Path("/work3/s233559/Thesis/data/dataset/halueval_clean.csv")
    output_path = Path("/work3/s233559/Thesis/prompts/generator/generator_helueval_v1.jsonl")
