...
if __name__ == "__main__":
    ...
    try:
        ...
        opt.role = "generator" #"generator"  # ή "judge"
        opt.num_runs = 1
        opt.aggregation_method = "oneshot"
        opt.promptroot = "/work3/s233559/Thesis2/prompts/generator/generator_HaluEval_favoritism.jsonl"
        opt.dataset_name = extract_dataset_name(opt.promptroot, opt.role)
        ...
        # opt.promptroot = "/work3/s233559/Thesis2/prompts/judge/generator_mistral7_oneshot_HaluEval_to_judge.jsonl"
        # opt.dataset_name = extract_dataset_name(opt.promptroot, opt.role)
        ...
        # opt.promptroot = "/work3/s233559/Thesis2/prompts/judge/generator_mistral7_oneshot_BiasBio_to_judge.jsonl"
        # opt.dataset_name = extract_dataset_name(opt.promptroot, opt.role)
